			  	...
			  	<form action="#" method="post">
					...
					<div class="itemrow">
				  	...
				  	<div class="itemrow">
				  			...
				  			<div style="width: 80%; float: left;">
				  				<?php echo '<input type="text" name="location" value="'.$f_loca.'" placeholder="e.g: Palaymkunnu, Varkala">'; ?>
				  			</div>
				  		</div>
					<div class="itemrow">
				  			<div style="width: 20%; float: left;">
							...
							<div style="width: 80%; float: left;">
							  ...
							  <option value="Kochin University">Kochin University</option>
							  <option value="Abdulkalam Univesity">Abdul kalam Univesity</option>
							</select>
							</div>
						</div>
					<div class="itemrow">
				  			...
				  			<div style="width: 20%; float: left;">
				  				<p><?php echo '<input name="deadline" type="text" id="datepicker" placeholder="e.g: 30/10/2021" value="'.$f_dead.'">'; ?></p>
				  			</div>
				  		</div>
