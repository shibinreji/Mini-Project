						...
						while ($row = $query->fetch_assoc()) {
							...
							echo '
								...
								<div style="float: right;">';
									...
									echo '<form action="chat/data2.php?app_tut='.$post_by_id.'" method="post">
									<input type="submit" class="sub_button"  style="margin: 0px;" name="" value="Chat" />
									</form>';
								echo '</div>
								<div>
						...
						while ($row = $query->fetch_assoc()) {
							...
							echo '
								...
								<div style="float: right;">';
												...
												if($tution_confirm == "1"){
													echo '	<input type="button" class="sub_button" style="margin: 0px; background-color: #a76d6d; cursor: default;" name="" value="Already Confirm" />
													<form action="chat/data.php?app_tut='.$applied_by_id.'" method="post">
													<input type="submit" class="sub_button"  style="margin: 0px;" name="" value="Chat" />
													</form>';
												}else
												{
